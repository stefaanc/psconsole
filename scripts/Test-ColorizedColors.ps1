...
Set-PSConsoleWindowSize "$ROOT/playground/colorized-dark-red" -Width 40 -Height 43 -ScreenBufferHeight 43
...
Set-PSConsoleWindowSize "$ROOT/playground/colorized-dark-yellow" -Width 40 -Height 43 -ScreenBufferHeight 43
...
Set-PSConsoleWindowSize "$ROOT/playground/colorized-dark-green" -Width 40 -Height 43 -ScreenBufferHeight 43
...
Set-PSConsoleWindowSize "$ROOT/playground/colorized-dark-cyan" -Width 40 -Height 43 -ScreenBufferHeight 43
...
Set-PSConsoleWindowSize "$ROOT/playground/colorized-dark-blue" -Width 40 -Height 43 -ScreenBufferHeight 43
...
Set-PSConsoleWindowSize "$ROOT/playground/colorized-dark-magenta" -Width 40 -Height 43 -ScreenBufferHeight 43
...
Set-PSConsoleWindowSize "$ROOT/playground/colorized-light-orange" -Width 40 -Height 43 -ScreenBufferHeight 43
...
Set-PSConsoleWindowSize "$ROOT/playground/colorized-light-chartreuse" -Width 40 -Height 43 -ScreenBufferHeight 43
...
Set-PSConsoleWindowSize "$ROOT/playground/colorized-light-springgreen" -Width 40 -Height 43 -ScreenBufferHeight 43
...
Set-PSConsoleWindowSize "$ROOT/playground/colorized-light-azure" -Width 40 -Height 43 -ScreenBufferHeight 43
...
Set-PSConsoleWindowSize "$ROOT/playground/colorized-light-violet" -Width 40 -Height 43 -ScreenBufferHeight 43
...
Set-PSConsoleWindowSize "$ROOT/playground/colorized-light-rose" -Width 40 -Height 43 -ScreenBufferHeight 43
...
Set-PSConsoleWindowSize "$ROOT/playground/powershell-dark" -Width 40 -Height 43 -ScreenBufferHeight 43
...
Set-PSConsoleWindowSize "$ROOT/playground/powershell-light" -Width 40 -Height 43 -ScreenBufferHeight 43
...
Set-PSConsoleWindowSize "$ROOT/playground/powershell-legacy" -Width 40 -Height 43 -ScreenBufferHeight 43
...
Set-PSConsoleWindowSize "$ROOT/playground/powershell-campbell" -Width 40 -Height 43 -ScreenBufferHeight 43
