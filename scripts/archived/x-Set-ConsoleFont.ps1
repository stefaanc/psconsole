...
# use:
#
#     Set-PSConsoleFont "$FontFace" "$FontSize"
#
# for instance:
#
#     Set-ConsoleFont "Lucida Console" 14
#
# remark that the font-face has to be one of the fonts specified in the registry
# under 'HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Console\TrueTypeFont'
#
# based on:
#
...
#
param(
    [Parameter(Position=0)][string]$Name = "Lucida Console",
    [Parameter(Position=1)][ValidateRange(5,72)][int]$Height = 14
)
